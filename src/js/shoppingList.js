...
const lorem = "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Vitae ipsa possimus debitis dignissimos ipsum consequuntur voluptatibus facere vero itaque magni, vel veniam delectus provident molestiae id libero totam excepturi perferendis!"
...
function deleteItem(event) {
    if(event.target.classList.contains("delete-btn-icon") || event.target.nodeName === "BUTTON") {
